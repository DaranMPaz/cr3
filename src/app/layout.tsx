...
import { FooterContainer, FooterColumn, FooterCta, FooterLink, FooterLogo, FooterSocial } from './components/footer'

const PlusJakartaSans = Plus_Jakarta_Sans({ subsets: ['latin'] })

export const metadata: Metadata = {
  title: 'CR3 Auditoria',
  description: 'Auditoria de Terceira Parte para Logística Reversa de Embalagens',
}
  ...
  return (
    <html lang="pt-br">
      <body className={PlusJakartaSans.className}>
        <main className='bg-theme-gray2-900'>
          {children}
        </main>
        <FooterContainer>
          <FooterLogo />
          ...
          <FooterColumn title='Termos'>
            ...
            <FooterLink link='/' text='Termos Legais' />
            <FooterLink isBlank link='https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm' text='LGPD' />
          </FooterColumn>
