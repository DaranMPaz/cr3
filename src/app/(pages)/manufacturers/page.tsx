...
export default function Manufacturers() {
  return (
    <div className="flex flex-col h-full text-zinc-100">
      ...
      {/* SOBRE O PROCESSO */}
      <div data-aos="fade-up" className="flex flex-col gap-20 w-full max-w-[1600px] mx-auto relative my-20">

        <div className='pb-8 border-b border-zinc-800 w-max mx-auto'>
          <h2 className='text-2xl md:text-4xl leading-snug md:leading-tight max-w-2xl text-theme-blue-500 uppercase font-bold text-center'>como funciona o processo</h2>
        </div>
