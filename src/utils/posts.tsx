export const postList = [
    {
      ...
      'subtitle1': "'A implementação da ISO 9001 pode trazer diversos benefícios significativos para um",
      ...
      'subtitle2': "A implementação da ISO 9001 pode trazer diversos benefícios significativos para um",
